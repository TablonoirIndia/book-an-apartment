...
function App() {
  // ── No more fetch here — SettingsProvider handles it ──
  return (
    <SettingsProvider>
      <LoadScript
          ...
          <Provider store={store}>
            <ToastProvider>
              <Routes>
                ...
                <Route path="/apartment-view/:masterPlanId"                      element={<ApartmentViewer />} />
                <Route path="/floor/:floorId"                                     element={<FloorPlanPage />} />
                <Route path="/unit/:plotId"                                       element={<UnitPage />} />
                <Route path="/unit/:plotId/room/:roomId"                         element={<RoomPanoramaPage />} />
                <Route path="/floor/:floorId/room/:roomId"                       element={<PanoramaViewer />} />
                <Route path="/unit/:plotId/gallery/:index"                       element={<GalleryPanoramaPage />} />
